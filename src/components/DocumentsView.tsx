  ...
  return (
    <div id="documents-view-container" className="flex flex-col lg:flex-row h-full w-full gap-6">
      ...
      <div className="flex-1 flex flex-col min-w-0 space-y-4">
        {/* Interactive Breadcrumb Bar & View Header */}
        <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-xs space-y-3">
            ...
            <div className="flex items-center gap-2 flex-wrap text-xs text-slate-600 font-medium">
              <button
                ...
                className={`hover:text-blue-600 transition-colors flex items-center gap-1.5 ${
                  !selectedFolderId && selectedCategory === 'all' ? 'text-blue-600 font-bold' : 'text-slate-600'
                }`}
              >
                <span>🏠</span>
                <span>Archiv</span>
              ...
              {activeFolder && (
                <>
                  <button
                    type="button"
                    onClick={() => {
                      setFolderModalParentId(activeFolder.id);
                      setEditingFolder(null);
                      setFolderModalOpen(true);
                    }}
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 border border-slate-200 rounded-xl transition-colors"
                    title="Ordner löschen"
                  >
